...
\begin{equation*}
    f(t)=\mathcal{F}^* c(t)=\sum_{n=-\infty}^\infty c[n]e^{in\omega t} (t\in\mathbb{R})
\end{equation*}
とおいて
\begin{equation*}
    c[n]=\mathcal{F}f[n]=\frac{1}{T}\int_0^T f(t)e^{-in\omega t}\mathrm{d}t (n\in\mathbb{Z})
\end{equation*}
...
\begin{equation}
    (Aa)[n]\equiv\sum_{j=-m}^m \alpha_ja[n-j]=b[n] (n\in\mathbb{Z}) \label{eq2-18}
\end{equation}
...
\begin{equation*}
    \Tilde{A}(t)(\mathcal{F}^* a)(t)=(\mathcal{F}^* b)(t) (t\in\mathbb{R})
\end{equation*}
...
　もし，条件
\begin{equation}
    \Tilde{A}(t)\neq 0 (t\in\mathbb{R}) \label{eq2-19}
\end{equation}
